...
angular.module('app.core').run(['$templateCache', function($templateCache) {$templateCache.put('app/core/404.html','<div class=container><div class=row><div class="col-sm-offset-3 col-sm-6"><div class=app-content><div class=header-text><h1>Error 404</h1><h3>Page Not Found!</h3><hr>Pelase visit <a ui-sref=home>Home</a></div></div></div></div></div>');
...
$templateCache.put('app/desicionMatrix/decision-matrix.html','<div class="decision matrix"><div class="row top-panel"><<<<<<< HEAD<div class="col-md-6 col-sm-6">=======<div class=col-sm-3>>>>>>>> ca33ece083e0cf03afca946fe935ac3c9f12d15e<h4 class=app-header-sub-title>{{vm.decision.name}}</h4></div><div class=col-sm-9><div class=pull-right><div class="btn-group btn-group-sm btns-view"><a ng-click=vm.toggleTargetHover() ng-class="{\'btn-primary\': vm.toggleTargetHoverFlag}" class=btn><span class="glyphicon glyphicon-screenshot"></span> Target</a></div><div class="btn-group btn-group-sm btns-view"><a ui-sref="decisions.view({id: vm.decisionId})" ui-sref-active=btn-primary class="btn btn-default"><span class="glyphicon glyphicon-th-list"></span> List</a> <a ui-sref="decisions.matrix({id: vm.decisionId})" ui-sref-active=btn-primary class="btn btn-default"><span class="glyphicon glyphicon-th"></span> Matrix</a></div></div></div></div><div class=matrix-table-wrapper><div ng-show=vm.decisionsSpinner class=app-loader-small><span class="glyphicon glyphicon-refresh app-loader-animation"></span>LOADING...</div><div id=matrix-table class="main-panel matrix-table js-matrix-table"><div id=panel class="app-panel matrix-table-panel clearfix"><div class=matrix-table-header><div class=matrix-table-row><div class="matrix-table-col matrix-table-group matrix-table-group-name"><div class=matrix-table-group-title></div><div class=matrix-table-row><div class=matrix-table-col data-col-id=col-name><div class="matrix-table-title app-sorter-wrapper matrix-content-name">Name<div class=app-sorter><span class="app-sorter-top glyphicon glyphicon-triangle-top" ng-click="vm.orderByDecisionProperty(\'name\', \'ASC\')"></span> <span class="app-sorter-bottom glyphicon glyphicon-triangle-bottom" ng-click="vm.orderByDecisionProperty(\'name\', \'DESC\')"></span></div></div></div></div></div><div class=scroll-group><div class="matrix-table-col matrix-table-group matrix-table-group-criteria" ng-repeat="group in vm.criteriaGroups track by $index"><div class=matrix-table-group-title>{{group.name}}</div><div class=matrix-table-row><div class=matrix-table-col ng-repeat="criteria in group.criteria | orderBy:\'criterionId\'" data-col-id=criteria-{{criteria.criterionId}} ng-click=vm.selectCriterion(criteria) ng-class="{\'selected\' : criteria.isSelected}"><div class="matrix-table-title app-sorter-wrapper">{{criteria.name}} <button class="hide btn btn-sm btn-default pull-right" ng-click="vm.editCriteriaCoefficient($event, criteria)"><criteria-coefficient-indicator coefficient=criteria.coefficient></criteria-coefficient-indicator></button><div class=app-sorter><span class="app-sorter-top glyphicon glyphicon-triangle-top"></span> <span class="app-sorter-bottom glyphicon glyphicon-triangle-bottom"></span></div></div></div></div></div><div class="matrix-table-col matrix-table-group" ng-repeat="group in vm.characteristicGroups track by $index"><div class=matrix-table-group-title>{{group.name}}</div><div class=matrix-table-row><div class=matrix-table-col ng-repeat="characteristic in group.characteristics track by $index" data-col-id=characteristic-{{characteristic.characteristicId}}><div class="matrix-table-title app-sorter-wrapper">{{characteristic.name}}<div class=app-sorter><span class="app-sorter-top glyphicon glyphicon-triangle-top"></span> <span class="app-sorter-bottom glyphicon glyphicon-triangle-bottom"></span></div></div></div></div></div></div></div></div><div class=matrix-table-aside><div class=matrix-table-aside-content><div class=matrix-table-item ng-repeat="item in vm.decisionMatrixList track by item.decision.decisionId"><div class=matrix-table-row id=decision-name-row-{{item.decision.decisionId}}><div class="matrix-table-col matrix-table-col-name" data-col-id=col-name><div class="matrix-table-col-content matrix-content-name">{{item.decision.name}} <small class="pull-right hide" ng-show=item.criteriaCompliancePercentage><<<<<<< HEAD Criteria compliance: {{item.criteriaCompliancePercentage}}</small> ======= Criteria compliance: {{item.criteriaCompliancePercentage}} >>>>>>> ca33ece083e0cf03afca946fe935ac3c9f12d15e</div></div></div></div></div></div><div id=matrix-table-body class=matrix-table-body><div id=matrix-table-content class=matrix-table-content style="width: {{vm.tableWidth}}"><div class="matrix-table-item matrix-table-item-content" ng-repeat="item in vm.decisionMatrixList track by item.decision.decisionId"><div class=matrix-table-row id=decision-row-{{item.decision.decisionId}}><div class="matrix-table-col matrix-table-group matrix-criteria-group" ng-repeat="group in vm.criteriaGroups track by $index"><div class=matrix-table-row><div class="matrix-table-col empty" ng-repeat="criteria in group.criteria | orderBy:\'criterionId\'" data-col-id=criteria-{{criteria.criterionId}}><div class=matrix-table-col-content data-criterion-id={{criteria.criterionId}}><div class=app-rating-votes><span><span class="glyphicon glyphicon-thumbs-up"></span>0</span></div><div class=app-item-additional-wrapper><div class=app-item-comments><span class="glyphicon glyphicon-comment"></span>0</div></div></div></div></div></div><div class="matrix-table-col matrix-table-group" ng-repeat="group in vm.characteristicGroups track by $index"><div class=matrix-table-row><div class="matrix-table-col empty" ng-repeat="characteristic in group.characteristics track by $index" data-col-id=characteristic-{{characteristic.characteristicId}}><div class=matrix-table-col-content data-characteristic-id={{characteristic.characteristicId}}><div class=app-item-additional-wrapper><div class=app-item-comments><span class="glyphicon glyphicon-comment"></span>0</div></div></div></div></div></div></div></div></div><div id=matrix-table-content-copy></div></div></div></div><div class=martix-footer><<<<<<< HEAD<app-paginator></app-paginator></div></div>=======<div class=row><div class=col-sm-12><app-paginator></app-paginator></div></div></div>>>>>>>> ca33ece083e0cf03afca946fe935ac3c9f12d15e</div>');
...
$templateCache.put('app/components/appHeader/app-header.html','<header class=app-header><div class=row><<<<<<< HEAD<div class="col-sm-5 header-menu-btn clearfix">=======<div class="col-md-4 header-menu-btn clearfix">>>>>>>> ca33ece083e0cf03afca946fe935ac3c9f12d15e<div class=navbar-brand><a ui-sref=home><strong>Decision</strong><span class=app-light>Wanted</span></a></div><div class=app-panel-search><input class="form-control search-input" type=text> <span class="glyphicon glyphicon-search search-input-icon"></span></div></div><<<<<<< HEAD<div class="col-sm-3 text-center"><span class=header-text>Millions of lemmings can\'t be wrong!</span></div><div class="col-sm-4 header-login">=======<div class="col-md-4 text-center"><span class=header-text>Millions of lemmings can\'t be wrong!</span></div><div class="col-md-4 header-login">>>>>>>> ca33ece083e0cf03afca946fe935ac3c9f12d15e<app-login></app-login></div></div></div></div></header>');
